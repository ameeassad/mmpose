"""
Prints the categories dictionary for COCO dataset with the skeleton information based on the mmpose meta information.
"""

from mmpose.apis import MMPoseInferencer

# Initialize the inferencer with AK model
